...
import (
	...
	database "github.com/lasthyphen/DijetsNetworkBinary/database"
	ids "github.com/lasthyphen/DijetsNetworkBinary/ids"
	djtx "github.com/lasthyphen/DijetsNetworkBinary/vms/components/djtx"
	status "github.com/lasthyphen/DijetsNetworkBinary/vms/platformvm/status"
...
func (m *MockInternalState) AddRewardUTXO(txID ids.ID, utxo *djtx.UTXO) {
	m.ctrl.T.Helper()
...
func (m *MockInternalState) AddUTXO(utxo *djtx.UTXO) {
	m.ctrl.T.Helper()
...
func (m *MockInternalState) GetRewardUTXOs(txID ids.ID) ([]*djtx.UTXO, error) {
	m.ctrl.T.Helper()
...
func (m *MockInternalState) GetUTXO(utxoID ids.ID) (*djtx.UTXO, error) {
	m.ctrl.T.Helper()
