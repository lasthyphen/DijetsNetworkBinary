...
import (
	...
	"github.com/lasthyphen/DijetsNetworkBinary/snow/engine/snowman/bootstrap"
	...
	"github.com/lasthyphen/DijetsNetworkBinary/utils/formatting/address"
	"github.com/lasthyphen/DijetsNetworkBinary/utils/json"
	"github.com/lasthyphen/DijetsNetworkBinary/utils/logging"
	"github.com/lasthyphen/DijetsNetworkBinary/utils/math/meter"
	"github.com/lasthyphen/DijetsNetworkBinary/utils/resource"
	"github.com/lasthyphen/DijetsNetworkBinary/utils/timer"
	...
	"github.com/lasthyphen/DijetsNetworkBinary/vms/platformvm/config"
...
var (
	...
	// DJTX asset ID in tests
	djtxAssetID = ids.ID{'y', 'e', 'e', 't'}
	...
	// each key controls an address that has [defaultBalance] DJTX at genesis
	keys = crypto.BuildTestKeys()

	defaultMinValidatorStake = 5 * units.MilliDjtx
	defaultMaxValidatorStake = 500 * units.MilliDjtx
	defaultMinDelegatorStake = 1 * units.MilliDjtx
...
func defaultGenesis() (*BuildGenesisArgs, []byte) {
	...
	buildGenesisArgs := BuildGenesisArgs{
		...
		InitialSupply: json.Uint64(360 * units.MegaDjtx),
	}
...
func TestGenesis(t *testing.T) {
	...
	for _, utxo := range genesisState.UTXOs {
		...
		addrs := ids.ShortSet{}
		addrs.Add(addr)
		utxos, err := djtx.GetAllUTXOs(vm.internalState, addrs)
		if err != nil {
