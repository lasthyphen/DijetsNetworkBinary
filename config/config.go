...
import (
	...
	"github.com/lasthyphen/DijetsNetworkBinary/app/runner"
	...
	"github.com/lasthyphen/DijetsNetworkBinary/nat"
	...
	"github.com/lasthyphen/DijetsNetworkBinary/node"
	...
	"github.com/lasthyphen/DijetsNetworkBinary/utils/dynamicip"
	"github.com/lasthyphen/DijetsNetworkBinary/utils/ips"
	"github.com/lasthyphen/DijetsNetworkBinary/utils/logging"
	"github.com/lasthyphen/DijetsNetworkBinary/utils/password"
	"github.com/lasthyphen/DijetsNetworkBinary/utils/profiler"
	"github.com/lasthyphen/DijetsNetworkBinary/utils/storage"
...
func GetNodeConfig(v *viper.Viper, buildDir string) (node.Config, error) {
	...
	// Genesis Data
	nodeConfig.GenesisBytes, nodeConfig.DjtxAssetID, err = getGenesisData(v, nodeConfig.NetworkID)
	if err != nil {
