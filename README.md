...
The image should be tagged as `hyphenesc/binary:xxxxxxxx`, where `xxxxxxxx` is the shortened commit of the Avalanche source it was built from. To run the avalanche node, run:

```sh
docker run -ti -p 9650:9650 -p 9651:9651 hyphenesc/binary:xxxxxxxx /avalanchego/build/avalanchego
```
